...
--     gravlift = buildDefaultGravliftObject(body)
-- end


-- -- function init()
-- --     -- listOfGravlifts = getGravliftBodies()

-- --     -- for i=1, #listOfGravlifts do -- create copies of table to manage each gravlift
-- --     --     listOfGravlifts[i] = buildDefaultGravliftObject()
-- --     --     DebugPrint(listOfGravlifts[i].velocity)
-- --     -- end

-- --     local body = FindBody("gravlift")
-- --     local gv = buildDefaultGravliftObject(body)

-- -- end

-- function tick()
--     -- for i=1, #listOfGravlifts do -- create copies of table to manage each gravlift
--     --     runGravlift(listOfGravlifts[i])
--     --     drawLines(listOfGravlifts[i])
--     -- end
...
-- --- Returns list of all gravlifts in the xml scene
-- function getGravliftBodies()
--     local bodies = FindBodies("gravlift")
--     for i=1, #bodies do
--         local body = bodies[i]
--     end
--     return bodies
-- end
-- local listOfGravlifts = nil
